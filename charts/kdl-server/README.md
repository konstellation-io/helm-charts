...
| projectOperator.image | object | `{"pullPolicy":"IfNotPresent","repository":"konstellation/kdl-project-operator","tag":"0.21.1"}` | Image registry The image configuration for the base service |
